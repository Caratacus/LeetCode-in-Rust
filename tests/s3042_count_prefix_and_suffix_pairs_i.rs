// Tests for Problem 3042: Count Prefix and Suffix Pairs I
// Java reference: src/test/java/g3001_3100/s3042_count_prefix_and_suffix_pairs_i/SolutionTest.java

use leetcode_in_rust::s3042::count_prefix_and_suffix_pairs_i::Solution;
