// Tests for Problem 2246: Longest Path With Different Adjacent Characters
// Java reference: src/test/java/g2201_2300/s2246_longest_path_with_different_adjacent_characters/SolutionTest.java

use leetcode_in_rust::s2246::longest_path_with_different_adjacent_characters::Solution;
...
fn test_longest_path3() {
    assert_eq!(
        Solution::longest_path(
            ...
            "ofarlvkejasusszlxapxqmpecaduhuogzltxuclafjbrvqtsidmmrjjespdupikvyopweptnjteylnixcjjfsubmhcekgbdorwihftfbtrqhzinccijwbpjaafkdplnjrydmkrluvdcmmoohwgkdmeuuqtsktbyl".to_string()
        ),
        18
    );
}
